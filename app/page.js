      ...
      <div className=" max-w-max mx-2">
        <form onSubmit={addBookmark} className="mb-8 flex gap-2">
          ...
          <button
            type="submit"
            disabled={isAdding}
            className="bg-black text-white px-4 py-2 rounded hover:bg-gray-800 disabled:opacity-80 disabled:cursor-not-allowed min-w-25 flex items-center justify-center gap-2"
          >
            {isAdding && (
              <svg
